...
threshold_list = [(210, 255)]

# Set the target temp range here
min_temp_in_celsius = 29.0
max_temp_in_celsius = 39.0
...
while(True):
    ...
    img = sensor.snapshot()
    blob_stats = []
    blobs = img.find_blobs(threshold_list, pixels_threshold=200, area_threshold=200, merge=False)
